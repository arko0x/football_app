...
class TeamInfoGUI:
    ...
    def show_team_info_window(self, team_name, season):
        ...
        player_label = Label(master=self.team_window, text="Player", font=("Verdana", MainGUI.STANDINGS_ELEM_SIZE, "bold"),
              bg="#00203F", fg="#ADEFD1")
        ...
        nationality_label = Label(master=self.team_window, text="Nationality", font=("Verdana", MainGUI.STANDINGS_ELEM_SIZE, "bold"),
              bg="#00203F", fg="#ADEFD1")
        ...
        height_label = Label(master=self.team_window, text="Height", font=("Verdana", MainGUI.STANDINGS_ELEM_SIZE, "bold"),
              bg="#00203F", fg="#ADEFD1")
        height_label.grid(row=0, column=3)
        height_label.bind("<Button-1>", lambda x: self.__sort_players_info(3))
        height_label["cursor"] = "hand2"
        weight_label = Label(master=self.team_window, text="Weight", font=("Verdana", MainGUI.STANDINGS_ELEM_SIZE, "bold"),
              bg="#00203F", fg="#ADEFD1")
        weight_label.grid(row=0, column=4)
        weight_label.bind("<Button-1>", lambda x: self.__sort_players_info(4))
        weight_label["cursor"] = "hand2"
        games_label = Label(master=self.team_window, text="Games", font=("Verdana", MainGUI.STANDINGS_ELEM_SIZE, "bold"),
              bg="#00203F", fg="#ADEFD1")
        games_label.grid(row=0, column=5)
        games_label.bind("<Button-1>", lambda x: self.__sort_players_info(5))
        games_label["cursor"] = "hand2"
        goals_label = Label(master=self.team_window, text="Goals", font=("Verdana", MainGUI.STANDINGS_ELEM_SIZE, "bold"),
              bg="#00203F", fg="#ADEFD1")
        goals_label.grid(row=0, column=6)
        goals_label.bind("<Button-1>", lambda x: self.__sort_players_info(6))
        goals_label["cursor"] = "hand2"
        assists_label = Label(master=self.team_window, text="Assists", font=("Verdana", MainGUI.STANDINGS_ELEM_SIZE, "bold"),
              bg="#00203F", fg="#ADEFD1")
        ...
        yellow_cards_label = Label(master=self.team_window, text="Yellow cards", font=("Verdana", MainGUI.STANDINGS_ELEM_SIZE, "bold"),
              bg="#00203F", fg="#ADEFD1")
        ...
        red_cards_label = Label(master=self.team_window, text="Red cards", font=("Verdana", MainGUI.STANDINGS_ELEM_SIZE, "bold"),
              bg="#00203F", fg="#ADEFD1")
